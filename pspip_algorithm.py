...
class PutSpacedPointsInPolygonsAlgorithm(QgsProcessingAlgorithm):
    ...
    def __init__(self):
        super().__init__()
        """Unfortunately, the conventional method of implementing i18n (using .ts and .qm files) did not work
           In order to still be able to provide a translation into German, I implemented the following 'hack'.
        """
